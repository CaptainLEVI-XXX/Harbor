...
Keep public setup commands in the relevant guide rather than adding
READMEs to nested folders. Keep internal operating notes in ignored `docs/`.
Leave dependency and separately maintained client
