...
export const RECEIPTS: Receipt[] = [
  ...
  // still queued, but Harbor is not quoting it - selectable so it can say why
  { requestId: 18990, entitlementWei: 6300000000000000000n, markWei: null, queuedDays: 4, state: 'pending' },
